...
public class PageInfo {
	public static Map<PageType, PageInfo> pageRoute =  new HashedMap();
		static {
			...
			pageRoute.put(PageType.SITE_LOGIN_PAGE, new PageInfo("Home page","/sites/users/logins.jsp", null));		
			pageRoute.put(PageType.SITE_REGISTRATION_PAGE, new PageInfo("Home page","/sites/users/registrations.jsp", null));		
